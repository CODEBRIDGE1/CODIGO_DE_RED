            ...
            {#if showUserDropdown}
              ...
              <div class="absolute right-0 top-full mt-1 w-56 bg-white rounded-xl shadow-xl border border-gray-200 z-50 py-1 overflow-hidden">
                ...
                <div class="py-1">
                  ...
                  <button
                    disabled
                    class="w-full flex items-center justify-between gap-3 px-4 py-2 text-sm text-gray-400 cursor-not-allowed text-left"
                  >
                    <div class="flex items-center gap-3">
                      <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span class="text-xs bg-gray-100 px-1.5 py-0.5 rounded">Pronto</span>
                  </button>
                  <button
                    disabled
                    class="w-full flex items-center justify-between gap-3 px-4 py-2 text-sm text-gray-400 cursor-not-allowed text-left"
