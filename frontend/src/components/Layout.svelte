      ...
      {#if user?.isSuperadmin}
        ...
        {#each adminMenuItems as item}
          <button
            ...
            class="w-full flex items-center px-4 py-3 text-left rounded-lg transition-colors hover:bg-purple-100"
            class:bg-purple-50={currentPath === item.path}
            class:text-purple-600={currentPath === item.path}
