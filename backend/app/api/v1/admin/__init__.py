...
from app.api.v1.admin import quote_items, tenants, users, companies, security_levels, quotes, audit_logs, organization
...
router.include_router(organization.router, prefix="/organization", tags=["Admin - Organization"])
